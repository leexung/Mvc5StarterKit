// ---------------------------------------------------------------------- 
// <copyright file="AccessDefaults.cs" company="Izenda">
...
namespace Mvc5StarterKit.IzendaBoundary.Models.Permissions.Access
{
    /// <summary>
    /// Access defaults
    /// </summary>
    public class AccessDefaults
    {
        ...
        /// Access defaults
        /// </summary>
        //public List<UserPermission> Value { get; set; }
