// ---------------------------------------------------------------------- 
// <copyright file="DashboardCategoriesSubcategories.cs" company="Izenda">
...
namespace Mvc5StarterKit.IzendaBoundary.Models.Permissions.Dashboards
{
    /// <summary>
    ...
    public class DashboardCategoriesSubcategories
    {
        ...
        /// Constructor
        /// </summary>
        public DashboardCategoriesSubcategories()
        {
            CategoryAccessibility = new CategoryAccessibility();
            CanCreateNewCategory = new CanCreateNewCategory();
        }
    }
}
